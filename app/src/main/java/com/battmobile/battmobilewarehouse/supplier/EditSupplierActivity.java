...
public class EditSupplierActivity extends AppCompatActivity {
    Menu menu;
    String TAG = EditSupplierActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.setActionBarScreen("Edit Supplier", getSupportActionBar());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_item_tick) {
            if (Utils.isNetworkConnected(EditSupplierActivity.this)) {
    ...
    private void editProductAPI() {
        Velocity.post(UtilityConstraints.UrlLocation.EDIT_SUPPLIER)
