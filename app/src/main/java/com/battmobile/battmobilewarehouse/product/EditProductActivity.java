...
public class EditProductActivity extends AppCompatActivity {
    ...
    String brand_id = "", image_url = "";
    TextView tvBrand;
    public static final int RequestPermissionCode = 1;
    private Uri uri;
    ImageView imgProduct;
    File actualImage;
    String TAG = EditProductActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.setActionBarScreen("Edit Product", getSupportActionBar());
        ...
        etSku.setText(getIntent().getStringExtra("sku"));
        etSize.setText(getIntent().getStringExtra("size"));
        brand_id = getIntent().getStringExtra("brand_id");
        tvBrand.setText(getIntent().getStringExtra("brand_title"));
        image_url = getIntent().getStringExtra("image");
        Picasso.with(EditProductActivity.this).load(image_url).placeholder(R.drawable.default_dp).into(imgProduct);
        rlBrand.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivityForResult(new Intent(EditProductActivity.this, SelectBrandActivity.class)
                        .putExtra("for", "brand"), 101);
            }
        });
        rlImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (checkPermission()) {
                    final Dialog dialog = new Dialog(EditProductActivity.this);
                    ...
                    textCamera.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            RxGallery.photoCapture(EditProductActivity.this).subscribe(new Consumer<Uri>() {
                                @Override
                    ...
                    textGallery.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            // Close dialog
                            RxGallery.gallery(EditProductActivity.this, false, RxGallery.MimeType.IMAGE).subscribe(new Consumer<List<Uri>>() {
                                @Override
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(EditProductActivity.this, new
            ...
            case RequestPermissionCode:
                if (grantResults.length > 0) {
                    ...
                    if (StoragePermission && RecordPermission) {
                        Toast.makeText(EditProductActivity.this, R.string.permission_granted,
                        ...
                        Toast.makeText(EditProductActivity.this, R.string.permission_allow, Toast.LENGTH_SHORT).show();
                    }
                }
                break;
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_item_tick) {
            if (Utils.isNetworkConnected(EditProductActivity.this)) {
                if (etSku.getText().toString().trim().length() == 0) {
                    ...
                    Toast.makeText(EditProductActivity.this, "Select Brand", Toast.LENGTH_SHORT).show();
                } else {
                    if (uri == null) {
    ...
    public void compressImage() {
        try {
            ...
            actualImage = FileUtil.from(EditProductActivity.this, uri);
            if (actualImage == null) {
    ...
    private void updateImageAPI(String image) {
        RequestBuilder requestBuilder = Velocity.post(UtilityConstraints.UrlLocation.EDIT_PRODUCT);
