...
public class BrandsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.setActionBarScreen("Brands", getSupportActionBar());
        ...
        sessionManager = new SessionManager(BrandsActivity.this);
        linearLayoutManager = new LinearLayoutManager(getApplicationContext(), RecyclerView.VERTICAL, false);
        rvMyTransactions.setLayoutManager(linearLayoutManager);
        progressBarMore = findViewById(R.id.more_progress);
        brandsAdapter = new BrandsAdapter(this, this, list);
        rvMyTransactions.setAdapter(brandsAdapter);
    ...
    public void editProduct(BrandsModel model) {
        startActivityForResult(new Intent(BrandsActivity.this, EditBrandsActivity.class)
                .putExtra("id", model.getId())
                .putExtra("name", model.getName())
                .putExtra("status", model.isStatus()), EDIT_REQUEST_CODE);
    }
                ...
                .connect(new Velocity.ResponseListener() {
                    ...
                    public void onVelocityFailed(Velocity.Response error) {
                        ...
                        try {
                            ...
                            Toast.makeText(BrandsActivity.this, mainObject.getString("message"), Toast.LENGTH_SHORT).show();
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_item_add) {
            if (Utils.isNetworkConnected(BrandsActivity.this)) {
                startActivityForResult(new Intent(BrandsActivity.this, AddBrandsActivity.class), ADD_REQUEST_CODE);
            } else
