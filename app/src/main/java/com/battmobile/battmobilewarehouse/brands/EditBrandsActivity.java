...
public class EditBrandsActivity extends AppCompatActivity {
    Menu menu;
    String TAG = EditBrandsActivity.class.getSimpleName();
    EditText etName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.setActionBarScreen("Edit Brands", getSupportActionBar());
        ...
        else rbInActive.setChecked(true);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_item_tick) {
            if (Utils.isNetworkConnected(EditBrandsActivity.this)) {
    ...
    private void addProductAPI() {
        Velocity.post(UtilityConstraints.UrlLocation.EDIT_BRAND)
